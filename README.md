...
App donde se lista los paises del mundo mediante restcountries API, detalle de un pais, dark/light theme busqueda por: input de busqueda y filtro de paises por region y mucho mas.
### The challenge
...
## Dark theme
![Mobile Preview](public/dark-theme.png)

## Ligth theme
![Mobile Preview](public/light-theme.png)

## Mobile Page
![Mobile Preview](public/mobile-page.png)

## Detail Country Page
![Mobile Preview](public/detail-page.png)

## Detail Mobile Country Page
![Mobile Preview](public/detail-mobile-page.png)
